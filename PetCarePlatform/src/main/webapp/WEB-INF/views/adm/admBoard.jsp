...
<body>
	<br><br><br><br><br>
	<section class="banner-area" style="padding: 130px;">
		<div class="container">
			<div class="row">
	...
	<section class="department-area section-padding4" style="padding: 50px 0 60px 0">
		<div class="container">
			<div class="row">
			...
			<div class="blog_right_sidebar" id="sidebar">
				<form id="frm" action="" method="post" onsubmit="return false" onkeypress="eventkey();">
					<aside class="single_sidebar_widget search_widget" style="display: flex;">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button class="btn btn-default" type="button" onclick="searchData()">
...
<script>
	...
	function searchData() {
		var
		let = $("#search option:selected").val();
		var le = $("#data").val();
		console.log(let);
		console.log(le);
